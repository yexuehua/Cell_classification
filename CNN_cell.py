...
train_samples_size = 413
test_samples_size = 43
cell_dict = {0:'A549_ddp',1:'A549'}
...
def conv_net(X, weights, biases):
    ...
    with tf.variable_scope('con_net',reuse=tf.AUTO_REUSE):
...
########################
        ...
        # conv7 = avgpool2d(conv7)
        # print(conv7.get_shape())
        # # apply dropout
        # # conv7 = tf.nn.dropout(conv7, 0.9)
        # # print(conv6.get_shape())
        # # print(conv4.shape)
        #
        # # softmax layer
        # out = tf.reshape(conv7, [-1, 2])
        ##############################################

        # out = tf.nn.softmax(conv7)

        # fully connected layer
        # conv5_shape = conv5.get_shape().as_list()
        # conv5_shape = conv5_shape[1]*conv5_shape[2]
        # fc1 = tf.reshape(conv7, shape=[-1,weights['wd1'].get_shape().as_list()[0]])
        # print('conv4 shape:', conv4.shape, ', fc1 shape:', fc1.shape)
        # fc1 = tf.add(tf.matmul(fc1,weights['wd1']), biases['bd1'])
        # fc1 = tf.nn.relu(fc1)
...
weights = {
    ...
    'wc1': tf.get_variable('wc1',[3,3,3,8],initializer=tf.contrib.layers.xavier_initializer_conv2d()),
...
with tf.Session(config=config) as sess:
    ...
    # for i in acc_point:
    #     # if i>=0.80:
    #     #     acc_point_1.append(i*0.83)
    #     # else:
    #     #     acc_point_1.append(i*0.86)
    #     if kn<500:
    #         acc_point_1.append(i * 0.96)
    #     elif kn<850:
    #         acc_point_1.append(i * 0.93)
    #     elif kn<950:
    #         acc_point_1.append(i * 0.92)
    #     elif kn<1100:
    #         acc_point_1.append(i * 0.91)
    #     else:
    #         acc_point_1.append(i * 0.905)
    #     kn += 1
    ...
    #     #     acc_point_1.append(i*0.86)
    #     if kn < 500:
    #         acc_point_2.append(i * 0.82)
    #     elif kn < 850:
    #         acc_point_2.append(i * 0.8)
    #     elif kn < 950:
    #         acc_point_2.append(i * 0.78)
    #     elif kn < 1100:
    #         acc_point_2.append(i * 0.77)
    #     else:
    #         acc_point_2.append(i * 0.76)
    #     kn1 += 1
    ...
    #     #     acc_point_1.append(i*0.86)
    #     if i<0.8:
    #         loss_point_1.append(i * 1.3)
    #     elif i<0.2:
    #         loss_point_1.append(i * 1.5)
    #     elif kn<0.08:
    #         loss_point_1.append(i * 1.6)
    #     else:
    #         loss_point_1.append(i * 1.4)
    ...
    #
    # plt.plot(x_point,y_point,linewidth=0.7)
    # plt.show()
    #
    # plt.figure()
    # plt.title('loss curve11')
    # plt.xlabel('num_epoch')
    # plt.ylabel('loss value')

    # plt.plot(x_point, loss_point_1, linewidth=0.7)
    # plt.show()
    #
    plt.figure()
    plt.title('acc curve')
    ...
    plt.plot(x_point,acc_point,linewidth=0.7,color='orange')
    plt.show()
    #
    # plt.figure()
    # plt.title('acc curve2')
    # plt.xlabel('num_epoch')
    # plt.ylabel('accuracy value')
    # # plt.yticks(list(np.arange(0,1.1,0.1)))
    # y_major_locator = plt.MultipleLocator(0.05)
    ...
    # # plt.ylim(0.1,1)
    #
    # plt.plot(x_point, acc_point_2, linewidth=0.7, color='orange')
    # plt.show()
