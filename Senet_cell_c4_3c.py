...
def Evaluate(sess):
    ...
    # /for PC9 data
    test_batch_x, test_batch_y = get_test_data(test_data_path, 512, 4)
    ...
    return test_acc, test_loss, test_pred, test_label, summary
...
train_data_path = "/public/home/yexuehua/PycharmProjects/Cell_classification/images/cellprofiler_4c/train"
test_data_path = "/public/home/yexuehua/PycharmProjects/Cell_classification/images/cellprofiler_4c/test"
result_path = "./result/cellprofile-senet-c4-3c"
#train_data_path = "/public/home/yexuehua/li/cellprofiler/train"
#test_data_path = "/public/home/yexuehua/li/cellprofiler/test"
#result_path = "./result/cellprofile-cnn"
# training set: 240
# test set: 60
...
#optimizer = tf.train.AdamOptimizer(learning_rate=decaylearning_rate, beta1=0.9,
...
with tf.Session() as sess:
    ...
    # y_test_TP = [0]*total_epochs
    # y_test_TN = [0]*total_epochs
    # y_test_FP = [0]*total_epochs
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        test_acc, test_loss, test_pred, test_label, test_summary = Evaluate(sess)
        ...
        # y_test_TP[epoch-1] = test_TP
        # y_test_TN[epoch-1] = test_TN
        # y_test_FP[epoch-1] = test_FP
        # y_test_FN[epoch-1] = test_FN
        # y_test_AUC[epoch-1] = test_AUC

    df=pd.DataFrame(columns=["x","y_tain_loss","y_train_acc","y_test_acc"])
    df["x"] = x_point
