...
# import os
#
# sample_dir = "/public/home/xiongzhengsi/PycharmProjects/cell_pheontype/pre_data/class_A/"
# lfilenames = []
# labelsnames = []
# print('starting:')
...
# print(lab)
# print(sorted(lab))
# print(list(sorted(lab)))
#
# print(lfilenames,labelsnames,sep='\n')
...
directory="/public/home/xiongzhengsi/PycharmProjects/cell_pheontype/pre_data/class_A/"                                                     #定义样本路径
...
with tf.Session() as sess:	# 建立会话（session）
    ...
    try:
        for step in np.arange(1):
            ...
            showimg(step,value[1],np.asarray( value[0]*65535,np.uint16),10)       #显示图片
            showimg(step,value2[1],np.asarray( value2[0]*65535,np.uint16),10)       #显示图片
